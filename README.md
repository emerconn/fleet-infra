...
- Securely access K8s by exposing ingress, egress, & the K8s API to a [tailnet](https://tailscale.com/kb/1136/tailnet), controlled via the [`tailscale-operator`](https://tailscale.com/kb/1236/kubernetes-operator)
