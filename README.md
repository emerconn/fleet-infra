...
- Exposing ingress, egress, & the K8s API to my [tailnet](https://tailscale.com/kb/1136/tailnet), controlled via the [`tailscale-operator`](https://tailscale.com/kb/1236/kubernetes-operator)
...
- Cloud-based SaaS secrets manager controlled via the [`vault-secrets-operator`](https://github.com/hashicorp/vault-secrets-operator)
